/* Generated by GOB (v2.0.9) on Sat May 28 16:44:43 2005
...
#line 105 "xfce-mcs-channel.gob"
		...
		if (self->client) {
			g_return_if_fail(self->client == actor);
			g_object_unref (self->client);
		}
					
		if (self->manager) {
			g_return_if_fail(self->manager == actor);
...
#line 576 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 123 "xfce-mcs-channel.gob"
static McsSetting * 
xfce_mcs_channel_get_setting_low (XfceMcsChannel * self, gchar const * name)
#line 582 "xfce-mcs-channel.c"
{
...
#line 589 "xfce-mcs-channel.c"
{
#line 124 "xfce-mcs-channel.gob"
...
#line 603 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 136 "xfce-mcs-channel.gob"
gchar * 
xfce_mcs_channel_get_setting (XfceMcsChannel * self, gchar const * name)
#line 609 "xfce-mcs-channel.c"
{
...
#line 616 "xfce-mcs-channel.c"
{
#line 137 "xfce-mcs-channel.gob"
...
#line 643 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 162 "xfce-mcs-channel.gob"
gchar * 
...
#line 162 "xfce-mcs-channel.gob"
	g_return_val_if_fail (XFCE_IS_MCS_CHANNEL (self), (gchar * )0);
#line 656 "xfce-mcs-channel.c"
{
#line 163 "xfce-mcs-channel.gob"
...
#line 193 "xfce-mcs-channel.gob"
	g_return_val_if_fail (XFCE_IS_MCS_CHANNEL (self), (gboolean )0);
#line 715 "xfce-mcs-channel.c"
{
#line 194 "xfce-mcs-channel.gob"
...
#line 730 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__


#line 211 "xfce-mcs-channel.gob"
void 
xfce_mcs_channel_set_setting (XfceMcsChannel * self, gchar const * name, gchar const * value)
#line 737 "xfce-mcs-channel.c"
{
...
#line 780 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 246 "xfce-mcs-channel.gob"
void 
xfce_mcs_channel_delay_notify (XfceMcsChannel * self)
#line 786 "xfce-mcs-channel.c"
{
...
#line 246 "xfce-mcs-channel.gob"
	g_return_if_fail (XFCE_IS_MCS_CHANNEL (self));
#line 793 "xfce-mcs-channel.c"
{
#line 247 "xfce-mcs-channel.gob"
...
#line 823 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 261 "xfce-mcs-channel.gob"
void 
xfce_mcs_channel_set_setting_int (XfceMcsChannel * self, gchar const * name, int value)
#line 829 "xfce-mcs-channel.c"
{
...
#line 261 "xfce-mcs-channel.gob"
	g_return_if_fail (XFCE_IS_MCS_CHANNEL (self));
#line 836 "xfce-mcs-channel.c"
{
#line 262 "xfce-mcs-channel.gob"
	 /* only mcs manager */
		if (self->manager)
...
#line 866 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 276 "xfce-mcs-channel.gob"
void 
xfce_mcs_channel_delete_setting (XfceMcsChannel * self, gchar const * name)
#line 872 "xfce-mcs-channel.c"
{
...
#line 276 "xfce-mcs-channel.gob"
	g_return_if_fail (XFCE_IS_MCS_CHANNEL (self));
#line 879 "xfce-mcs-channel.c"
{
#line 277 "xfce-mcs-channel.gob"
	 /* only mcs manager */
		if (self->manager)
			xfce_mcs_manager_delete_setting (self->manager, self->channel_name, name);
	}}
#line 886 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__

#line 284 "xfce-mcs-channel.gob"
void 
xfce_mcs_channel_delete (XfceMcsChannel * self)
#line 892 "xfce-mcs-channel.c"
{
...
#line 296 "xfce-mcs-channel.gob"
	g_return_if_fail (XFCE_IS_MCS_CHANNEL (self));
#line 939 "xfce-mcs-channel.c"
{
#line 297 "xfce-mcs-channel.gob"
	 /* only mcs manager */
		if (self->manager)
			xfce_mcs_manager_save_channel_to_file (self->manager, self->channel_name, filename);
	}}
#line 946 "xfce-mcs-channel.c"
#undef __GOB_FUNCTION__
