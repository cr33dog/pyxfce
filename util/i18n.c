...
_wrap_xfce_get_file_localized(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "s:localized_file", kwlist, &filename))
        return NULL;
...
_wrap_xfce_get_dir_localized(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "s:localized_dir", kwlist, &directory))
        return NULL;
...
_wrap_xfce_get_file_localized_r(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "sis:localized_file_r", kwlist, &buffer, &length, &filename))
        return NULL;
...
_wrap_xfce_get_dir_localized_r(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "sis:localized_dir_r", kwlist, &buffer, &length, &directory))
        return NULL;
...
PyMethodDef pyi18n_functions[] = {
    ...
    { "localized_file", (PyCFunction)_wrap_xfce_get_file_localized, METH_VARARGS|METH_KEYWORDS },
    { "localized_dir", (PyCFunction)_wrap_xfce_get_dir_localized, METH_VARARGS|METH_KEYWORDS },
    { "localized_file_r", (PyCFunction)_wrap_xfce_get_file_localized_r, METH_VARARGS|METH_KEYWORDS },
    { "localized_dir_r", (PyCFunction)_wrap_xfce_get_dir_localized_r, METH_VARARGS|METH_KEYWORDS },
